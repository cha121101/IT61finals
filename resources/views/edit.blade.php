        ...
        <form class="w-full max-w-lg py-10 pl-10 my-28 border-solid border-2 border-sky-500 " action="{{ route('update.student' , ['id' => $value->id])}}" method="post">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" name="studentname" value="{{$value->studentname}}">
                            </div>
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-zip">
                                    Age
                                </label>
                                <input name="age"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip" type="number" value="{{$value->age}}" >
                            </div>
                            </div>
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0" >
                            ...
                            <div class="relative">
                                <select name="yearandsection" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                                            <option value="{{$value->yearandsection}}">{{$value->yearandsection}}</option>
                                            <optgroup label="BSTM">
